...
public class RestServiceApplication implements CommandLineRunner {
    ...
    private void addOrderTable() {
        ...
        jdbcTemplate.execute("CREATE TABLE Orders(number INTEGER PRIMARY KEY, name VARCHAR(255), handleBarType VARCHAR(255), material VARCHAR(255), gearShift VARCHAR(255), handleMaterial VARCHAR(255), price DOUBLE, deliveryDate DATE, supplier VARCHAR(255))");
